...
alert-adrenaline-desc = оповещения-адреналин-деска
alert-adrenaline-name = оповещения-адреналин-имя
alert-bleed-desc = оповещения-кровотечение-описание
alert-bleed-name = имя-оповещения
alert-borgbattery-desc = оповещения-батарея-деска
alert-borgbattery-name = оповещения-имя-батареи
alert-borgbatterynone-desc = оповещения-нет-батареи-деска
alert-borgbatterynone-name = оповещения-без-имя-батареи
alert-borgcrit-desc = оповещения-критическое описание
alert-borgcrit-name = имя-критического предупреждения
alert-borgdead-desc = оповещения-мертвые-деска
alert-borgdead-name = оповещения-мертвое имя
alert-borghealth-desc = оповещения-здоровья-деска
alert-borghealth-name = имя-здоровья-оповещения
alert-buckled-desc = оповещения-пряжки-деска
alert-buckled-name = имя-оповещения с пряжкой
alert-cold-desc = оповещения-слишком холодно-описание
alert-cold-name = оповещения-слишком холодное имя
alert-debug1-desc = Отлаживать
alert-debug1-name = Отладка1
alert-debug2-desc = Отлаживать
alert-debug2-name = Отладка2
alert-debug3-desc = Отлаживать
alert-debug3-name = Отладка3
alert-debug4-desc = Отлаживать
alert-debug4-name = Отладка4
alert-debug5-desc = Отлаживать
alert-debug5-name = Отладка5
alert-debug6-desc = Отлаживать
alert-debug6-name = Отладка6
alert-ensnared-desc = оповещения-пойманные-деска
alert-ensnared-name = оповещения-пойманное-имя
alert-fire-desc = оповещения о пожаре
alert-fire-name = имя-оповещения-в-огне
alert-handcuffed-desc = оповещения-наручники-деска
alert-handcuffed-name = оповещения-имя-наручниках
alert-highpressure-desc = оповещения-высокое давление-описание
alert-highpressure-name = имя-предупреждения-высокого давления
alert-hot-desc = оповещения-слишком-горячие-дескаты
alert-hot-name = оповещения-слишком-горячее имя
alert-humancrit-desc = оповещения-критическое описание
alert-humancrit-name = имя-критического предупреждения
alert-humandead-desc = оповещения-мертвые-деска
alert-humandead-name = оповещения-мертвое имя
alert-humanhealth-desc = оповещения-здоровья-деска
alert-humanhealth-name = имя-здоровья-оповещения
alert-internals-desc = оповещения-внутренности-деска
alert-internals-name = имя-внутреннего оповещения
alert-lownitrogen-desc = оповещения-низкий-азот-десс
alert-lownitrogen-name = оповещения-имя-низкого-азота
alert-lowoxygen-desc = оповещения-низкий уровень кислорода-десс
alert-lowoxygen-name = оповещения-низкое-кислородное-имя
alert-lowpressure-desc = оповещения-низкое давление-описание
alert-lowpressure-name = имя-предупреждения-низкого давления
alert-muted-desc = оповещения-без звука-деска
alert-muted-name = оповещения-приглушенные-имя
alert-pacified-desc = оповещения-pacified-desc
alert-pacified-name = оповещения-умиротворенное-имя
alert-parched-desc = оповещения-пересохшие-деска
alert-parched-name = оповещения-пересохшее-имя
alert-peckish-desc = оповещения-голод-обнаружение
alert-peckish-name = оповещения-голод-имя
alert-pilotingshuttle-desc = оповещения-пилотирование-деска
alert-pilotingshuttle-name = имя-пилотирования-оповещения
alert-pulled-desc = оповещения-вытащил-деска
alert-pulled-name = имя-вытащенного-оповещения
alert-pulling-desc = оповещения-вытягивание-деска
alert-pulling-name = имя-вытягивания-оповещения
alert-stamina-desc = оповещения-выносливость-обнаружение
alert-stamina-name = оповещения-выносливость-имя
alert-starving-desc = оповещения-голодающие-деска
alert-starving-name = оповещения-голодающее-имя
alert-stealthy-desc = оповещения-стелси-десс
alert-stealthy-name = оповещения-скрытое-имя
alert-stun-desc = оповещения-ошеломленные-деска
alert-stun-name = оповещения-ошеломленное-имя
alert-thirsty-desc = оповещения-жаждущие-деска
alert-thirsty-name = имя-жаждущего оповещений
alert-toxins-desc = оповещения-высокое-токсичное-описание
alert-toxins-name = оповещения-высокое-токсичное-имя
alert-vowbroken-desc = оповещения-обет-сломанный-десс
alert-vowbroken-name = оповещения-обет-нарушенное-имя
alert-vowofsilence-desc = оповещения-обет-тишина-десс
alert-vowofsilence-name = оповещения-обет-тишина-имя
alert-walking-desc = оповещения-ходьба-деска
alert-walking-name = оповещения-ходячее-имя
alert-weightless-desc = оповещения-невесомость-деска
alert-weightless-name = оповещения-невесомое-имя
