ent-AU14JobFORECONFirstReconRifleman-name = Стрелок ФОРЕКОН (3-я сторона)
ent-AU14IDCardFORECONFirstReconRifleman-name = ID-карта стрелка ФОРЕКОН
ent-AU14IDCardFORECONFirstReconRifleman-desc = Кусочек закодированного компрессированного стекловолокна. Используется для идентификации и контроля доступа.
