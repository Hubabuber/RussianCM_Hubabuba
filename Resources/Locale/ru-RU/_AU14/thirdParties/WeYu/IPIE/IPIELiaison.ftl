ent-AU14JobIPIELawyer-name = Урист Ц.М. МакХэндс
ent-AU14JobIPIELawyerSynth-name = Юрист IPIE W-Y (3-я сторона, синтетик)

ent-AU14JobIPIELawyer = Юрист WY IPIE (третья сторона)
    .suffix = AU14, ВеЮ
