...
ent-CMBeakerBase = item

ent-RMCBeakerBaseMetallic = item

ent-RMCPressurizedCanisterBicaridine = канистра под давлением
    .desc = Контейнер под давлением. Внутренняя часть герметичного пакета с канистрой с реагентами. Совместим только с сумкой, оборудованием или резервуаром для хранения.
    .suffix = Бикаридин

ent-RMCPressurizedCanisterKeloDerm = канистра под давлением
    .desc = Контейнер под давлением. Внутренняя часть герметичного пакета с канистрой с реагентами. Совместим только с сумкой, оборудованием или резервуаром для хранения.
    .suffix = КелоДерм

ent-RMCPressurizedCanisterKelotane = канистра под давлением
    .desc = Контейнер под давлением. Внутренняя часть герметичного пакета с канистрой с реагентами. Совместим только с сумкой, оборудованием или резервуаром для хранения.
    .suffix = Келотан

ent-RMCPressurizedCanisterMeraBic = канистра под давлением
    .desc = Контейнер под давлением. Внутренняя часть герметичного пакета с канистрой с реагентами. Совместим только с сумкой, оборудованием или резервуаром для хранения.
    .suffix = МераБик

ent-RMCPressurizedCanisterTricordrazine = канистра под давлением
    .desc = Контейнер под давлением. Внутренняя часть герметичного пакета с канистрой с реагентами. Совместим только с сумкой, оборудованием или резервуаром для хранения.
    .suffix = Трикордразин

ent-RMCPressurizedCanisterTricordrazineRevival = канистра под давлением
    .desc = Контейнер под давлением. Внутренняя часть герметичного пакета с канистрой с реагентами. Совместим только с сумкой, оборудованием или резервуаром для хранения.
    .suffix = Трикордразин - Возрождение

ent-RMCSealedChemicalContainer = item
