...
ent-RMCL112SniperRifleSH = L112A2 обозначена стрелковая винтовка
    .desc = L112A2 DMR — более модульная версия модели A1. В этом пистолете отсутствует встроенный глушитель в пользу ствола с резьбой и имеется планка для крепления цевья.
    .suffix = Наполненный, сквош-головка

ent-RMCL112SniperRifleSuppressedSH = L112A1 обозначена стрелковой винтовкой
    .desc = L112A1 DMR, принятый на вооружение морпехи Royal Crown компании TSE в связи с признанной потребностью в огневой мощи дальнего действия для разведки и секретных операций и разработанный в тандеме с патроном HESH калибра 7,7x56 ммR.
    .suffix = Наполненный, сквош-головка
