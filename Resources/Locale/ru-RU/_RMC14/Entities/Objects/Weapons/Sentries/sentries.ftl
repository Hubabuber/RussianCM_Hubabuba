...
ent-RMCSentryConstruct = Сторожевое орудие ООН 571-С
    .desc = Развертываемая полуавтоматическая турель с возможностями наведения ИИ. Вооружен автопушкой М30 и барабанным магазином на 500 патронов.

ent-RMCTurretGaussModifiedCLF = модифицированная гаусс-башня УН-577
    .desc = Развертываемая полуавтоматическая турель с возможностями наведения ИИ. Вооружен автопушкой М30 и барабанным магазином большой емкости. Его система IFF повреждена кислотой и откроет огонь по любым целям в пределах досягаемости.
