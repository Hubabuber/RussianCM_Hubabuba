ent-ClothingMaskBandBlack-name = черная бандана
ent-ClothingMaskBandBlack-desc = Черная бандана, которая заставит вас выглядеть круто.

ent-ClothingMaskBandBlue-name = синяя бандана
ent-ClothingMaskBandBlue-desc = Синяя бандана, которая заставит вас выглядеть круто.

ent-ClothingMaskBandBotany-name = ботаническая бандана
ent-ClothingMaskBandBotany-desc = Бандана из ботаники, которая придаст вам крутости, изготовлена из натуральных волокон.

ent-ClothingMaskBandGold-name = золотая бандана
ent-ClothingMaskBandGold-desc = Золотая бандана, которая заставит вас выглядеть круто.

ent-ClothingMaskBandGreen-name = зеленая бандана
ent-ClothingMaskBandGreen-desc = Зеленая бандана, которая поможет вам выглядеть круто.

ent-ClothingMaskBandGrey-name = серая бандана
ent-ClothingMaskBandGrey-desc = Серая бандана, которая поможет вам выглядеть круто.

ent-ClothingMaskBandRed-name = красная бандана
ent-ClothingMaskBandRed-desc = Красная бандана, которая заставит вас выглядеть круто.

ent-ClothingMaskBandSkull-name = череп бандана
ent-ClothingMaskBandSkull-desc = Бандана с черепом, которая сделает вас еще круче.

ent-ClothingMaskBandMerc-name = бандана наемника
ent-ClothingMaskBandMerc-desc = Для защиты головы от солнца, насекомых и других опасностей высшего пути.
