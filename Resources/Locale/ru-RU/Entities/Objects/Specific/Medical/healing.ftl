...
ent-Bloodpack1 = пакет крови
    .desc = Содержит революционный универсальный заменитель крови, созданный на основе передовых медицинских достижений Nanotrasen.
    .suffix = Одинокий

ent-Bloodpack10Lingering = пакет крови
    .desc = Содержит революционный универсальный заменитель крови, созданный на основе передовых медицинских достижений Nanotrasen.
    .suffix = 10, Затяжной

ent-Brutepack = пакет от синяков
    .desc = Лечебный гель и бинты, предназначенные для лечения тупых травм.
    .suffix = Полный

ent-Brutepack1 = пакет от синяков
    .desc = Лечебный гель и бинты, предназначенные для лечения тупых травм.
    .suffix = Одинокий

ent-Brutepack10Lingering = пакет от синяков
    .desc = Лечебный гель и бинты, предназначенные для лечения тупых травм.
    .suffix = 10, Затяжной
...
ent-Gauze1 = рулон марли
    .desc = Немного стерильной марли, чтобы обернуть окровавленные культи.
    .suffix = Одинокий

ent-Gauze10Lingering = рулон марли
    .desc = Немного стерильной марли, чтобы обернуть окровавленные культи.
    .suffix = 10, Затяжной
...
ent-MedicatedSutureLingering0 = лечебный шовный материал
    .desc = Нить, пропитанная лекарством, эффективно лечит тупую травму и закрывает раны.
    .suffix = 0, Затяжной
...
ent-PillAmbuzolPlus = амбузол плюс таблетка
    .desc = Это не свечи.

ent-PillBicaridine = таблетка
    .desc = Это не свечи.
    .suffix = Бикаридин 10у

ent-PillCanisterBicaridine = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Бикаридин 10у, 5

ent-PillCanisterCharcoal = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Уголь 10у, 3

ent-PillCanisterCopper = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Медь 10у, 5

ent-PillCanisterDermaline = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Дермалин 10у, 5

ent-PillCanisterDexalin = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Дексалин 10у, 7

ent-PillCanisterDylovene = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Дыловене 10у, 5

ent-PillCanisterHyronalin = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Хироналин 10у, 5

ent-PillCanisterIron = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Железо 10у, 5

ent-PillCanisterKelotane = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Келотан 10у, 5

ent-PillCanisterPotassiumIodide = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Калия йодид 10ед, 5

ent-PillCanisterRandom = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Случайный

ent-PillCanisterTricordrazine = канистра для таблеток
    .desc = Вмещает до 10 таблеток.
    .suffix = Трикордразин 10у, 5
...
ent-RegenerativeMeshLingering0 = регенеративная сетка
    .desc = Используется для лечения даже самых тяжелых ожогов. Также эффективен против едких ожогов.
    .suffix = 0, Затяжной

ent-SyringeAmbuzol = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = амбузол

ent-SyringeBicaridine = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = бикаридин

ent-SyringeDermaline = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = дермалин

ent-SyringeEphedrine = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = эфедрин

ent-SyringeEthylredoxrazine = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = этилредоксразин

ent-SyringeHyronalin = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = гироналин

ent-SyringeInaprovaline = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = инапровалин

ent-SyringeIpecac = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = ипекакуана

ent-SyringePhalanximine = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = фаланксимин

ent-SyringeRomerol = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = ромерол

ent-SyringeSaline = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = солевой раствор

ent-SyringeSigynate = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = сигировать

ent-SyringeStimulants = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
    .suffix = гиперзин

ent-SyringeTranexamicAcid = шприц
    .desc = Используется для взятия образцов крови у мобов или для введения им реагентов.
