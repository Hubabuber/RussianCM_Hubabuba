...
ent-ActionXenoAcidMine = Acid Mine (40)
    .desc = Cause an acid explosion at the targeted location.

ent-ActionXenoAcidNormal = Corrosive Acid (100)
    .desc = Melts down a structure or item over time.

ent-ActionXenoAcidShotgun = Acid Shotgun (40)
    .desc = Launches multiple acid projectiles that deal increased damage to trapped targets.
...
ent-ActionXenoDeployTraps = Deploy Traps (60)
    .desc = Deploys a line of snaring traps.
...
ent-ActionXenoSpitPraetorian = Xeno Spit (25)
    .desc = Launches a projectile that will deal damage to the first enemy that it hits.
...
ent-ActionXenoSprayAcidBoiler = Spray Acid (40)
