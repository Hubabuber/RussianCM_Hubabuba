...
ent-CMArmorFreelancer = freelancer cuirass
    .desc = An armored protective chestplate scrapped together from various plates. It keeps up remarkably well, as the craftsmanship is solid, and the design mirrors such armors in the UPP and the UNMC. The many skilled craftsmen in the freelancers ranks produce these vests at a rate about one a month.
...
ent-RMCArmorMARSOCXM40 = marine raider armor
    .desc = A heavily customized suit of M3 armor. Used by Marine Raiders.
