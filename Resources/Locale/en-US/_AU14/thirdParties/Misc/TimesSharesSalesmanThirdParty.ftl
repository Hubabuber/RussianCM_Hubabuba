ent-AU14PartyJobTimeSharesSalesman = Timeshares Salesperson
    .suffix = AU14, Misc

ent-AU14SlingSatchelBlueTimeSharesSalesman = Black sling satchel
    .desc = A very sturdy satchel. This one has a sling strap.
    .suffix = Filled, Time Shares Salesman
